...
@TeleOp
class RedTwoDriverTeleOp(override val alliance: Alliance = Alliance.RED) : TwoDriverTeleOp()

@TeleOp
class BlueTwoDriverTeleOp(override val alliance: Alliance = Alliance.BLUE) : TwoDriverTeleOp()

open class TwoDriverTeleOp : BaseTeleOp() {
